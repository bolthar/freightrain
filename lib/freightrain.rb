...
require File.dirname(__FILE__) + '/freightrain/rubygnome_extensions/gtk_layout.rb'
require File.dirname(__FILE__) + '/freightrain/rubygnome_extensions/gtk_image.rb'
require File.dirname(__FILE__) + '/freightrain/rubygnome_extensions/gtk_treeview.rb'
